...
class Setup(object):
    ...
    def __init__(self):
        T = current.T
        self.db_options = [
            #'mysql://root:python@localhost/foxter'
            Field("uri", "string", notnull=True, default="sqlite://foxter.sqlite"),
        ...
        self.mail_options = [
            Field("server", "string", notnull=True, default="smtp.gmail.com:587"),
            Field("sender", "string", notnull=True, default="your-mail@your-domain.com"),
            Field("login", "string", notnull=False, default="user-name:password"),
            Field("setuptime", "datetime", notnull=True),
        ]
        ...
        self.auth_options = [
            ...
            Field("google", "list:string", notnull=True, default=["id:287394752870.apps.googleusercontent.com",
                                                                  "secret:eyurExndgto8qQ1kHVjcncqZ",
                                                                  "xoauth_displayname:foxter",
                                                                  "redirect_scheme:http", "redirect_uri:foxter.co/welcome/person/google/login",
        ...
        self.meta_options = [
            ...
            Field("keywords", "string", notnull=True, default="foxter.co, Noticias, Articulos, Amigos, foxter"),
            Field("description", "string", notnull=True, default="Foxter.co comparte informacion con el mundo"),
        ...
        self.comment_options = [
           ...
           Field("intense_acct", "string", notnull=False, default=""),
           Field("facebook_appid", "string", notnull=False, default=""),
