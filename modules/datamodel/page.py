...
class Report(BaseModel):
    ...
    def set_properties(self):
        ...
        reasons = ["Publicacion invalida",
                   "Violacion de derechos de autor",
                   "Falta de referencia/fuente",
                   "Contenido ofensivo o desagradable",
                   "Publicacion falsa o mentirosa",
                   "Usuário falso",
                   "Usuário ofensivo",
                   "Usuário no esta bajo las condiciones de la red",
                   "Otro motivo (Justifique abajo, porfavor)"]
